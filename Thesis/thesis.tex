...
In questo specifico caso la divisione applicata è stata 70\% e 30\%. Il procedimento di divisione è stato affidato a SciKit, una volta letto il file in ingresso e separata la colonna del valore da predirre è stato sufficiente applicare quanto segue:
% \vspace{10em}
\begin{lstlisting}[language=Python, frame=single, basicstyle=\small]
...
\begin{center}
  ...
  \begin{tabular}{ |c|c|c|c|c|c|c|c|c|c| }
     \hline
     \textbf{R2} & \textbf{1w} & \textbf{2w} & \textbf{4w} & \textbf{8w} & \textbf{12w} & \textbf{16w} & \textbf{20w} & \textbf{30w}  & \textbf{52w} \\
     \hline
     \hline
