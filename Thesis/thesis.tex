...
\begin{center}
  ...
  \begin{tabular}{ |c|c|c|c|c|c|c|c|c|c|c| }
    ...
    \hline
    GB & P & 88.2\% & 86.3\% & 80.8\% & 77.5\% & 74.8\% & 68.8\% & 60.1\% & - & -\\
    \hline
    \hline
    NN & R2 & 0.981 & 0.962 & 0.974 & 0.961 & 0.955 & 0.905 & 0.846 & 0.771 & -\\
    \hline
    NN & P & 89.4\% & 86.9\% & 84.2\% & 80.4\% & 72.9\% & 60.3\% & 51.3\% & 47.1\% & -\\
    \hline
  \end{tabular}
  }
\end{center}
...
\begin{center}
  \captionof{table}{Esecuzione cross-project: cassandra} \label{tab:cross_project_cassandra}
  \resizebox{\textwidth}{!}{
  \begin{tabular}{ |c|c|c|c|c|c|c|c|c|c|c| }
    \hline
    \textbf{Model} & \textbf{Metric} & \textbf{1w} & \textbf{2w} & \textbf{4w} & \textbf{8w} & \textbf{12w} & \textbf{16w} & \textbf{20w} & \textbf{30w}  & \textbf{52w} \\
