...
% La maggior parte degli errori deriva dal calcolo di errori più semplici, l'errore assoluto viene calcolato computando la differenza tra l'obbiettivo $y$ e la predizione $x$:
% \begin{center}
%   \begin{equation}
%     \epsilon = |y - x|
%   \end{equation}
