...
The following paragraphs will deal with the models used specifically.
...
% To make predictions for a query point $x$, each tree independetly predicts
% \begin{center}
%   \begin{equation}
